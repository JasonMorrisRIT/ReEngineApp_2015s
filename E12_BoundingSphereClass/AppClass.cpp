...
void AppClass::InitVariables(void)
{
	...
	m_pSphere1->GenerateSphere(m_fRadius2, 10, REGREEN);
...
void AppClass::Update(void)
{
	...
	m_pMeshMngr->PrintLine("y:" + std::to_string(m_v3Center1.x) + " ", RERED);
	m_pMeshMngr->PrintLine("z:" + std::to_string(m_v3Center1.x) + " ", RERED);
	...
	if (bAreColliding)
	{
		m_pMeshMngr->PrintLine("They are colliding", RERED);
	}
	else
	{
