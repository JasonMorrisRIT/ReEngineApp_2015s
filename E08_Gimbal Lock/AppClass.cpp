...
{
	super::InitWindow("jrm2516 - Gimbal Lock");
...
void AppClass::Update(void)
{
	...
	//m_mToWorld = quatOrienation;

	//this works to remove gimble lock, but has expontial growth and decay. Not sure how to go about fixing that.
	m_mToWorld = glm::mat4_cast(tempOrientation);
